...
본 프로젝트는 사용자가 입력한 키워드와 곡의 가사/장르 데이터를 분석하여 최적의 음악을 추천하는 시스템입니다. **Java Spring Boot**의 안정적인 서비스 운영 능력과 **Python Flask**의 데이터 분석 역량을 결합한 Polyglot 아키텍처로 설계되었습니다.
...
| **Rec-Engine** | Python 3.x, Flask, Gensim (Word2Vec), Scikit-learn, Pandas, NumPy |
| **Database** | MongoDB (NoSQL) |

---

## System Architecture
시스템은 확장성과 언어별 강점을 극대화하기 위해 **3-Tier 구조**로 설계되었습니다.
...
단순 추천을 넘어 정교한 개인화를 위해 세 가지 필터링 기법을 결합했습니다.
...
* **Metric**: `Precision@5`
* **User Satisfaction**: 10-point scale 평점 시스템을 통해 알고리즘의 성능을 지속적으로 개선
